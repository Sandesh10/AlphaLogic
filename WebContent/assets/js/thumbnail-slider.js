...
function ThumbnailSlider(a) {
    ...
    var mb = function (b) {
        ...
        , Ib = function () {
            ...
            mb(" ul li.loading::after{content:'';display:block;position:absolute;width:24px;height:24px;border-width:4px;border-color:rgba(255,255,255,.8);border-style:solid;border-top-color;border-radius:50%;margin:auto;left:0;right:0;top:0;bottom:0;}")
        }
        , Ab = function () {
