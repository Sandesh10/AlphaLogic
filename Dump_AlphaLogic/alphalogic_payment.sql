...
CREATE TABLE `payment` (
  ...
  `creditCardId` varchar(256) DEFAULT NULL,
  `creditCardExpDate` varchar(45) DEFAULT NULL,
  `CreditCardPin` varchar(45) DEFAULT NULL,
  `creditCardNo` varchar(256) DEFAULT NULL,
